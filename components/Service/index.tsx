...
const Service = () => {
	return(
		<div className="p-6 bg-gradient-to-b from-cyan-500 to-blue-500 drop-shadow-lg">
			<div className="text-center block mt-12">
            	<Header2 title="Szukasz profesjonalnej rehabilitacji?" dark={false}/>
            	<SubHeader title="Nasi specjaliści dobiorą właściwą metodę rehabilitacji abyś zawsze czuł się doskonale" />
            	<HRShort />
          	</div>
